...
export type ResolverFn<TContext, TModel> = ({
  source,
  ctx,
  args,
  info,
  ...
  ctx?: TContext
  info?: any
  cache: GraphQLPerRequestCache
}) => any
export type FieldResolverMap<TContext = any, TModel = any> = Record<
  string,
  ResolverFn<TContext, TModel>
>
export type EntityResolverMap<TContext = any, TModel = any> = Record<
  string,
  FieldResolverMap<TContext, TModel>
>
...
export type GraphQLEndpoint<TContext, TModel> = (
  args: GraphQLEndpointArgs<TContext, TModel>
) => Promise<any>
